...
<table>
<tr>
<td><img src="images/dashboard.png" alt="YAAMon dashboard (desktop)"></td>
<td><img src="images/dashboard-phone.png" alt="YAAMon dashboard (phone)" width="300"></td>
</tr>
</table>
...
| Method | Best for |
|--------|----------|
| [Debian / Ubuntu package](installation/deb.md) | ASL3 nodes (Raspberry Pi, x86 server) — recommended |
| [Pre-built binary](installation/binary.md) | Non-Debian Linux, manual systemd setup |
| [Docker](installation/docker.md) | Quick start, isolated environment |
| [docker-compose](installation/docker-compose.md) | Production Docker deployments |
| [Building from source](installation/building.md) | Development, custom builds |
...
- [Installation](installation/README.md) — all installation methods, migration from AllScan/Allmon3
- [Configuration](configuration/README.md) — config file reference, TLS, AMI, authentication
- [User Guide](user-guide/README.md) — dashboard, favorites, profile, passkeys
- [Security](security/README.md) — web security, AMI security
- [Troubleshooting](troubleshooting/README.md) — debug logging, common issues
- [CLI Reference](reference/cli.md) — all `yaamon` subcommands and flags
- [Design](design/README.md) — architecture, database schema, API, CI/CD

---

## Migrating from AllScan or Allmon3

See [Migration](installation/migration.md) — built-in import support, no conversion scripts needed.
...
BSD 3-Clause — see [LICENSE](https://github.com/jchonig/allstar-yaamon/blob/main/LICENSE).
